        ...
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[35%_65%] bg-gradient-to-br from-slate-50 via-indigo-50 to-slate-100">
            <aside className="hidden lg:flex flex-col justify-center p-12 bg-gradient-to-br from-indigo-600 to-indigo-800 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-md">
                    ...
                    <p className="text-lg text-indigo-100 leading-relaxed">Organize your team schedules, prevent conflicts, and keep everyone in sync.</p>
                    <div className="mt-8 space-y-4">
                        <div className="flex items-center gap-3 text-indigo-100">
                            ...
                            <span>Prevent overlapping shifts</span>
                        </div>
                        <div className="flex items-center gap-3 text-indigo-100">
                            ...
                            <span>4-hour minimum enforcement</span>
                        </div>
                        <div className="flex items-center gap-3 text-indigo-100">
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Your password" className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" />
                                </div>
                            </div>
